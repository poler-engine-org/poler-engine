...
///
/// M6 (VaultAppender): `Clone` — снапшот состояния внешнего digest в
/// точке «последняя полная страница»; поля — plain-значения, копирование
/// тривиально безопасно (никаких указателей/ресурсов).
#[derive(Clone)]
pub struct Sha256 {
    state: [u32; 8],
    buf: [u8; 64],
