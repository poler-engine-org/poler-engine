...
# Тесты: 1192/1192 (pnd-ffi), default 1130/1130, zig 21/21 + 33/33, golden 54 626 bit-for-bit
...
- Rust: **1192/1192** тестов (pnd-ffi; C2: +15 fly-семейство + золотые числа v783), default **1130/1130**; Zig: **21/21** exec + 33/33 крипто/ABI; golden-векторы PND: **54 626 bit-for-bit**.
