...
/// Все команды poler-shell v0.17.0 (полный реестр для `help`).
...
pub fn help_overview() -> String {
    ...
    let _ = writeln!(s, "poler-shell v0.17.0 — TUI Redesign (MiMo Code-style 4-pane + mouse + CRUD)");
