...
* обход `.gitignore` упрощён до списка SKIP_DIRS (`.git`, `target`,
...
85 тестов: 70 unit (математика ε/IIR, сканер скобок, raw-строки, PII,
разбиение предложений, K-hop, temporal-фильтр) + 15 интеграционных
