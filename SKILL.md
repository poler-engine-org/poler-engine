...
- Rust: **1238/1238** тестов (pnd-ffi; L1: +46 literary-семейство + золото v783), default **1176/1176**; Zig: **21/21** exec + 33/33 крипто/ABI; golden-векторы PND: **54 626 bit-for-bit**.
